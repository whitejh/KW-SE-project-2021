<template>
  <div>
    <section
      ...
      :style="
        'background-image: url(https://image.msscdn.net/images/goods_img/20200305/1336398/1336398_2_500.jpg);'
      "
    >
...
import ProductList1 from '@/components/shop/ProductList1.vue';
...
export default {
  ...
  methods: {
    changePage(page) {
      this.$store.dispatch('product/setProducts1', page);
    },
  },
};
</script>
