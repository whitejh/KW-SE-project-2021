      ...
      <div class="container">
        ...
        <div class="row g-3">
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card" style="width: 18rem">
              <a href="product_detail.html"
                ><img
                  src="https://image.msscdn.net/images/goods_img/20190430/1031260/1031260_4_500.jpg"
                  class="card-img-top"
                  alt="keyboard"
              /></a>
              <div class="card-body">
                <h5 class="card-title">21S/S 오버핏 피케티셔츠 (블랙)</h5>
                <p class="card-text">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card" style="width: 18rem">
              <img
                src="https://image.msscdn.net/images/goods_img/20190404/1005683/1005683_5_500.jpg"
                class="card-img-top"
                alt="mouse"
              />
              <div class="card-body">
                <h5 class="card-title">
                  마크 곤잘레스 사인로고 반팔 티셔츠 블랙
                </h5>
                <p class="card-text">
                  <span class="badge bg-dark">전자제품</span>
                  <span class="badge bg-dark">컴퓨터</span>
