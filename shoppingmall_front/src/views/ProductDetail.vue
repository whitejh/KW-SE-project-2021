            ...
            >
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  <img
                    src="http://earlyadopter.godohosting.com/goods_earlyadopter_godo_co_kr/162/1578368250813m2.jpg?cache_ver=2021021601"
                    class="d-block w-100"
                    alt="..."
                  />
                </div>
                <div class="carousel-item">
                  <img
                    src="http://earlyadopter.godohosting.com/goods_earlyadopter_godo_co_kr/162/1578368250328m4.jpg?cache_ver=2021021601"
                    class="d-block w-100"
                    alt="..."
                  />
                </div>
            ...
            <div class="card shadow-sm" style="width: 50em">
              <div class="card-body">
                ...
                <p class="card-text pb-3">
                  배송비 2,500원 | 도서산간(제주도) 배송비 추가 5,000원 |
                  택배배송 | 5일 이내 출고 (주말, 공휴일 제외)
                </p>
